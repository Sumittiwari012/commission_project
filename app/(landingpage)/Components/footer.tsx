...
function Footer() {
  return (
    <div className="sticky top-0 flex min-h-screen w-full flex-col items-center justify-center bg-gray-900  shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
            <footer className="w-full bg-slate-950 text-slate-400 py-16 px-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm">
                        ...
                        <li><a href="#" className="hover:text-blue-500 transition-colors">Studio Journal</a></li>
                        <li><a href="#" className="hover:text-blue-500 transition-colors">Collection 2025</a></li>
                        <li><a href="#" className="hover:text-blue-500 transition-colors">Design Ethics</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className="text-xs mb-6">Join 10,000+ creators for weekly design insights.</p>
                    <form className="flex flex-col gap-3">
                        <input type="email" placeholder="Email address" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-blue-600 transition-colors"/>
                        <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-lg text-sm transition-all active:scale-95">
                            Subscribe
                        </button>
                    </form>
                </div>
            ...
            <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-xs uppercase tracking-[0.2em] font-medium">
                <p>&copy; 2025 Studio Minimal. All rights reserved.</p>
