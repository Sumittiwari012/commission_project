      ...
      <main className="flex flex-col md:flex-row min-h-screen pt-[14vh]">
        ...
        >
          <div className="flex flex-col gap-10 items-center px-4 md:px-6 lg:px-8">
            ...
            {/* VIDEO SECTION — same click logic as images: opens fullscreen at index 5 */}
            <div
              onClick={() => setFullscreenIndex(5)}
              className="flex-shrink-0 overflow-hidden cursor-zoom-in"
              style={{
                width: 'clamp(260px, 27vw, 560px)',
                aspectRatio: '0.85'
              }}
